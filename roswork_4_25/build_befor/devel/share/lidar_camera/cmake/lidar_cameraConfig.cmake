...
if("TRUE" STREQUAL "TRUE")
  set(lidar_camera_SOURCE_PREFIX /home/hsax/roswork/src/lidar_camera)
  set(lidar_camera_DEVEL_PREFIX /home/hsax/roswork/devel)
  ...
  set(lidar_camera_INSTALL_PREFIX /home/hsax/roswork/install)
...
if(NOT "/home/hsax/roswork/src/lidar_camera/include " STREQUAL " ")
  set(lidar_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/hsax/roswork/src/lidar_camera/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hsax/roswork/src/lidar_camera/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lidar_camera_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "lidar_camera")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lidar_camera_NUM_DUMMY_TARGETS)
      set(lidar_camera_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lidar_camera::wrapped-linker-option${lidar_camera_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lidar_camera_NUM_DUMMY_TARGETS "${lidar_camera_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lidar_camera::wrapped-linker-option${lidar_camera_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lidar_camera_LIBRARIES "${interface_target_name}")
...
set(lidar_camera_EXPORTED_TARGETS "")
...
set(depends "roscpp;rospy;std_msgs;message_runtime;mmlidar")
